...
const SelectSignUpMethod = (props) => (
  <>
    ...
    <Modal.Body>
      ...
      <p>
        Creá una cuenta para ver contenido adicional, configurar alertas y seguir autores de tu interés.
      </p>
      ...
      <p>
        ¿Ya tenes una cuenta?{' '}<a href="#" onClick={props.onSelectSignIn}>Ingresá</a>
      </p>
      <p>
        Para hacer funcionar Red-Pri, guardamos información del usuario. Al hacer click en “Registrarse” aceptas los <Link href="/"><a>terminos y condiciones</a></Link>
      </p>
      </Container>
    </Modal.Body>
  </>
